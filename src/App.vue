  ...
  <div class="has-background-primary-light app-wrapper">
    ...
    <div class="p-5">
      <div class="navigation is-flex is-justify-content-space-between">
        <div>
          <div class="select is-success mr-2 mb-1">
          ...
          <button
            class="button is-primary mr-2 mb-1 is-outlined"
          ...
          <button
            ...
            @click="toggleShowAddTaskModal"
          >
            Add Task
          </button>
        </div>
        <div>
          <button class="button is-danger mb-2" @click="removeBoard">
            Remove Board
          </button>
        </div>
      </div>
